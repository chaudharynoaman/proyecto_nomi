...
<html>
<head>
	<title>Cambio de Contraseña | Nimbu</title>
    	...
    	<script type="text/javascript">
			$("#idOld-Password").password('toggle');
			$("#idNew-Password").password('toggle');
			$("#idConfirm-New-Password").password('toggle');
		</script>
...
<c:choose>
	...
	<div class="container">
		<form class="form-signin" method="post" action="cambiopassword" id="idForm-Cambio-Password" role="form" data-toggle="validator">
		<h2 class="form-signin-heading">Cambio de Contraseña</h2>
			...
			<div class="form-group">
				<button class="btn btn-md btn-primary btn-block" type="submit" id="idSubmit-Password-Change">GUARDAR NUEVA CONTRASEÑA</button>
			</div>
		
			<div id="msg-error-cambiopassword">
				<%
					String error_msg=(String)request.getAttribute("PasswordChangeErrorMessage");  
					if(error_msg!=null)
