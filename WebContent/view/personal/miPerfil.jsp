...
<title>Mi Perfil | Nimbu</title>
		...
		<script type="text/javascript">
			...
			function verDatos(){
				document.getElementById("idDatos-Personales-Modificar").style.visibility = "visible";
			}
		            		...
		            		<ul class="nav navbar-nav navbar-right" id="menu-items" style="text-transform: capitalize;">
		            			...
		            			<li class="dropdown">
		            				...
		            				<ul class="dropdown-menu" id="otro">
				        				...
				        				<!-- <li><a href="cambioemail">Cambiar Email</a></li>-->
...
<div class="container" id="idMi-Perfil-Container">
		...
		<!-- <input type="button" id="idBoton-Modificar-Datos-Personales" value="Modificar mis datos personales" onclick="verDatos()"/>-->
			...
			<form class="form-signin" method="post" action="modificardatos" id="idForm-Modificar-Datos" role="form" data-toggle="validator">
				...
				<div class="form-group has-feedback">
					<label for="labelNombreMod" class="control-label">Nombre</label>
						<input type="text" name="nombremod" value="${usuario.nombre}" class="form-control" id="idNombreMod"	pattern="^[a-zA-Z ÁÉÍÓÚáéíóúñÑ-]{2,30}$" data-error="El nombre introducido no es válido" required/>		
						<span class="glyphicon form-control-feedback"></span>
						<div class="help-block with-errors" id="one"></div>
				</div>
				
				<!-- <input type="text" name="apemod" value="${usuario.apellidos}">-->
				<div class="form-group has-feedback">
					<label for="labelApellidosMod" class="control-label">Apellidos</label>
					<input type="text" name="apemod" value="${usuario.apellidos}" class="form-control" id="idApellidosMod" pattern="^[a-zA-Z ÁÉÍÓÚáéíóúñÑ-]{2,30}$" data-error="El apellido introducido no es válido" required/>				
					<span class="glyphicon form-control-feedback"></span>
					<div class="help-block with-errors"></div>
				</div>
				
				<!-- <input type="text" name="emailmod"  value="${usuario.email}">-->				
				<%-- <div class="form-group has-feedback">			
					<label for="labelEmailMod" class="control-label">E-mail</label>
					<input type="email" name="emailmod" value="${usuario.email}" class="form-control" id="idEmailMod" 
				...
				<!-- <input type="submit" id="idSubmit-Modificar-Datos" value="Guardar Nuevos Datos">-->
