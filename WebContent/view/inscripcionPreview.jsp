...
<div class="container" id="idInscripcion-Preview-Container">	
	<p id="idMensaje-Inscripcion-Ok">Te has inscrito correctamente en: ${tituloJob}</p>
	<p id="idLink-Inscripcion-Preview"><a href="../job" >Volver a la lista de empleos</a></p>
</div>
