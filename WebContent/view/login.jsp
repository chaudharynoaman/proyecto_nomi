...
<head>
  	<title>Nimbu | Login</title> 
    	...
    	<script type="text/javascript">
			$("#idPasswordLogin").password('toggle');			
		</script>
...
<div class="container">
     		...
     		<form class="form-signin" action="login" method="post" id="idFormLogin" role="form" data-toggle="validator">
				<h2 class="form-signin-heading">Acceso Candidatos</h2>
				
				<div class="form-group has-feedback">			
					<label for="labelEmail" class="control-label">E-mail</label>
					<input type="email" name="emailLogin" class="form-control" id="idEmailLogin" 
				...
				<div class="form-group has-feedback">
					<label for="labelPassword" class="control-label">Contraseña</label>
					<input type="password" name="passwordLogin" class="form-control" id="idPasswordLogin" 
				...
				<div id="login-error-msg">
					<%
						String error_msg=(String)request.getAttribute("UserLoginErrorMessage");  
						if(error_msg!=null)
