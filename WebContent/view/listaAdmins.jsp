...
<html>
<head>
  		<title>Nimbu | Lista de Administradores</title> 
    	...
    	<link rel="stylesheet" type="text/css" href="../css/listaAdmins.css">   
...
<div class="container" id="idLista-admins-container">
	<h2 id="lista-admins-heading">Lista de Administradores activos</h2>
