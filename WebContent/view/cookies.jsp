...
<div class="container" id="idCookies-Container">
	<h3 id="cookies-headings">Cookies</h3>
	<p>Desde Nimbu España deseamos informarle de que nuestra página web utiliza cookies para medir y analizar 
	la navegación de nuestros usuarios.</p>

	<p>Las cookies son unos archivos que se instalan en el ordenador con la finalidad de obtener información 
	de la  navegación, medir y analizar la audiencia.</p>

	<p>Estas herramientas no obtienen datos personales como nombre o apellidos ni de la dirección postal 
	de la conexión. La información que obtienen está relacionada con el número de páginas visitas, el idioma, 
	red social en la que se publican nuestras noticias, la ciudad a la que está asignada la dirección IP 
	desde la que se accede, el número de nuevos usuarios, la frecuencia y reincidencia de las visitas, 
	el tiempo de visita, el navegador y el operador o tipo de terminal desde el que se realiza la visita.</p>

	<p>Esta información la utilizamos para mejorar nuestras páginas, detectar nuevas necesidades y valorar 
	las mejoras a introducir con la finalidad de prestar un mejor servicio a los usuarios que nos visitan 
	adaptándolas por ejemplo a los navegadores o terminales más utilizados.</p>

	<p>Para permitir, conocer, bloquear o eliminar las cookies instaladas en su equipo puede hacerlo 
