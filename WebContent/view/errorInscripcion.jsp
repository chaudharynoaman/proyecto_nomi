...
<div class="container" id="container-errorInscripcion">
	<p id="idError-Inscripcion-Mensaje">Se ha producido un error al realizar la inscripción</p>
	<p id="idError-Inscripcion-Mensaje">Inténtalo de nuevo mas tarde</p>
</div>
